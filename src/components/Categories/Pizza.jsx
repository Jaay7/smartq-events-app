...
import { Typography, Button, TextField, FormControl, InputLabel, Select, MenuItem, Checkbox } from '@mui/material';
    ...
    <div className={classes.main}>
      {
        ...
        data.error ? 'Error' :
        <>
          <div className={classes.banner} style={{backgroundImage: `url(${data.data.extras.categories.Pizza.bannerImage})`}}>
            <h2>Pizza</h2>
          </div>
          <Typography variant="h6" style={{marginLeft: '5%', alignSelf: 'flex-start'}}>Menu</Typography>
          <div className={classes.menu}>
            {data.data.menu.filter(item => item.category === 'Pizza').map(item => (
